...
function Youtube() {
    ...
    const search = (query) => {
        ...
        fetch(`https://youtube.googleapis.com/youtube/v3/search?part=snippet&q=${query}&key=AIzaSyBGVqJJg7aY8ZCPNNpnIL-bYjW7PwoWNwA&maxResults=30&type=video`, requestOptions)
    ...
    useEffect(() => {
        ...
        fetch("https://youtube.googleapis.com/youtube/v3/search?part=snippet&q=cat&key=AIzaSyBGVqJJg7aY8ZCPNNpnIL-bYjW7PwoWNwA&maxResults=30&type=video", requestOptions)
        .then(response => response.json())
